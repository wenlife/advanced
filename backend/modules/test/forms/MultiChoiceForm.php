...
use backend\modules\test\libary\Exchange;

/**
 * Login form
 */
class MultiChoiceForm extends Model implements Exchange
{
 /* @property integer $id
 ...
 */
    ...
    public function rules()
    {
        return [
            // required
            [['content', 'optionA','optionB','optionC','optionD','answer','chapter'], 'required'],
            [['date'], 'safe'],
    ...
    public function fillForm($model)
    {
        ...
        $db_record['answer'] = unserialize($db_record['answer']);      
    ...
    {
        $form = $post['MultiChoiceForm'];
        $form['answer'] = serialize($form['answer']);
