...
/**
 * TestpaperSearch represents the model behind the search form about `backend\modules\test\models\Testpaper`.
 */
class TestpaperSearch extends Testpaper
{
    ...
    public function rules()
    {
        return [
            [['id', 'state'], 'integer'],
            [['title', 'items', 'score', 'note', 'publisher', 'createdate'], 'safe'],
        ];
    }
