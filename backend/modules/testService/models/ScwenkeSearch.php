...
/**
 * ScwenkeSearch represents the model behind the search form of `backend\modules\testService\models\ScWenke`.
 */
class ScwenkeSearch extends ScWenke
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ScWenke::find()->where(['stu_school'=>$school,'test_id'=>$exam]);;
