...
class UploadForm extends Model
{
    ...
    {
        try{
            $userId = isset(Yii::$app->user->identity->username)?Yii::$app->user->identity->username:"000000";
            ...
            $bigImage = $this->crop();
            //配置大中小图上传路径
            // $bigImageUrl = $path.'/avatar_big'.'.'.$this->imageFile->extension;
            // $middleImageUrl = $path.'/avatar_middle'.'.'.$this->imageFile->extension;
            // $smallImageUrl = $path.'/avatar_small'.'.'.$this->imageFile->extension;
            $bigImageUrl = $path.'/avatar_big.png';
            $middleImageUrl = $path.'/avatar_middle.png';
            $smallImageUrl = $path.'/avatar_small.png';
            //生成缩略中小图
